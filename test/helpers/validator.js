...
class Validator {
    ...
    init() {
        ...
        this.commitPhaseEndBlock = this.commitPhaseStartBlock + this.commitPhaseBlockCount;
        ...
        this.stages[0] = {
            ...
            endBlock: this.commitPhaseStartBlock + this.commitPhaseBlockCount,
        ...
        for (let i = 1; i <= this.StageCount; i++) {
            ...
            this.stages[i] = {
                startBlock: lastStageBlockEnd + 1,
                endBlock: lastStageBlockEnd + this.StageBlockCount + 1,
